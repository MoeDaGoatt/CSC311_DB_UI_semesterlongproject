...
public class DbConnectivityClass {
    ...
    final String SQL_SERVER_URL = "jdbc:mysql://hamzacsc311server.mysql.database.azure.com/";
    final String DB_URL = "jdbc:mysql://hamzacsc311server.mysql.database.azure.com/"+DB_NAME;
